                ...
                shadow-lg">
                    <div className="flex flex-col gap-5 px-10 py-5 w-full">
                        ...
                        <div className="flex flex-col gap-4 justify-start">
                            <div className="flex flex-row gap-3 justify-start items-center w-8/12">
                                <p className="text-xl font-semibold text-right w-4/12">Họ và tên:</p>
                                <Input
                            ...
                            <div className="flex flex-row gap-3 justify-start items-center w-8/12">
                                <p className="text-xl font-semibold text-right w-4/12">Số điện thoại:</p>
                                <Input
                                    className="text-black max-md:max-w-full text-right"
                                    variant="bordered"
                            ...
                            <div className="flex flex-row gap-3 justify-start items-center w-8/12">
                                <p className="text-xl font-semibold text-right w-4/12">Email:</p>
                                <Input
                                    className="text-black max-md:max-w-full text-right"
                                    variant="bordered"
                            ...
                            <div className="flex flex-row gap-3 justify-start items-center w-8/12">
                                <p className="text-xl font-semibold text-right w-4/12">Ngày sinh:</p>
                                <Input
                                    className="text-black max-md:max-w-full text-right"
                                    variant="bordered"
                                    type="date"
                            ...
                            <div className="flex flex-row gap-3 justify-start items-start w-8/12">
                                <p className="text-xl font-semibold text-right w-4/12">Bio:</p>
                                <Textarea />
                            </div>
