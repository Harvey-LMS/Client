  ...
  return (
    <div className="flex flex-col justify-center px-16 py-20 font-semibold tracking-normal  max-md:px-5">
      <div className="flex justify-center items-center px-16 mt-52 max-md:px-5 max-md:mt-10 max-md:mr-1 max-md:max-w-full">
        <div className="flex flex-col items-center max-w-full w-[650px]">
          <div className="text-3xl font-extrabold leading-5 text-center max-md:max-w-full">
            <div className="text-green-500">WELCOME Lê Hoàng An,</div>
            <div className="mt-4">CÙNG NÂNG CAO TRÌNH ĐỘ CÁ NHÂN NHÉ</div>
          </div>
          ...
          <div className="mt-12 text-xl leading-5 text-zinc-700 text-opacity-60 max-md:mt-10 max-md:max-w-full">
