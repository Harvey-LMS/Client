...
const RegisterPage = () => {
   return (
      <div
         className="w-full fixed flex flex-col items-center justify-center  rounded-md shadow-sm 
    max-md:px-5 sm:mt-5 md:shadow-none top-28 z-10"
      >
         <div className="flex flex-row justify-center gap-5 max-md:flex-col max-md:gap-0">
            ...
            <div className="flex flex-col ml-5 max-md:ml-0 max-md:w-full border-gray-300 rounded-3xl shadow-lg border px-5 py-6">
               <div className="flex flex-col grow justify-center text-base leading-6 text-zinc-700 text-opacity-40  max-md:max-w-full ">
                  ...
                  ></input>
                  <button className="justify-center items-center self-center px-16 py-2 mt-3.5 max-w-full text-base font-medium tracking-wide leading-7 text-white uppercase bg-green-600 rounded-md w-[405px] max-md:px-5">
                     Đăng Ký
                  </button>
