          ...
          <div className="flex flex-col grow justify-center text-base leading-6 text-zinc-700 text-opacity-40  max-md:max-w-full ">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                type="date"
              />
              <RadioGroup label="Giới tính:" className="flex flex-row w-full">
            ...
            <Link href="/register/otp">
              <Button
                color="primary"
                className="justify-center items-center self-center px-16 py-2 mt-3.5 max-w-full text-base font-medium tracking-wide leading-7 text-white uppercase w-[405px] max-md:px-5"
              >
                Đăng Ký
              </Button>
            </Link>
