...
const Register = () => {
  ...
  return (
    <div
      className="w-full bg-background flex flex-col justify-center items-center"
    >
      <div
        className="flex flex-row justify-center gap-5 max-md:flex-col max-md:gap-0">

        <div className="flex flex-col w-[600px] max-md:ml-0 max-md:w-full max-lg:hidden max-sm:hidden max-md:hidden min-md:hidden">
          <Image
            alt="HarveyRegister"
            src={RegisterSVG}
        ...
        <motion.div
          ...
          <div className=" flex flex-col min-w-[500px] max-w-[500px]  px-8 py-7 mt-5 mb-4 bg-white border-gray-300 rounded-3xl shadow-lg border lg:w-1/3">
            ...
            <div className="flex flex-col gap-2 w-full justify-start items-start">
              ...
              <div className="mt-7 gap-1 tracking-normal leading-6 text-center flex flex-row items-center justify-center w-full text-lime-600 max-md:max-w-full">
