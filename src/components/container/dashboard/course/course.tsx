      ...
      <div>
         ...
         {data && data.length > 0 ? (
                  ...
                  <tbody>
                     {isFetching
                        ? Array.from({ length: 5 }).map((_, index) => (
                             <tr key={index}>
                                <td className="py-4 px-3 w-full h-16">
                                   <Skeleton className="w-full h-5 flex justify-center items-center rounded-lg" />
                                </td>
                                <td className="py-4 px-3 w-full h-20">
                                   <Skeleton className="w-full h-full flex justify-center items-center" />
                                </td>
                                <td className="py-4 px-3 w-full h-16">
                                   <Skeleton className="w-full h-3 flex justify-center items-center rounded-lg" />
                                </td>
                                <td className="py-4 px-3 w-full h-16">
                                   <Skeleton className="w-full h-3 flex justify-center items-center rounded-lg" />
                                </td>
                                ...
                                <td className="py-4 px-3 w-full h-16">
                                   <Skeleton className="w-full h-full flex justify-center items-center rounded-xl" />
                                </td>
                                <td className="py-4 px-3 w-full h-16">
                                   <Skeleton className="w-full h-full flex justify-center items-center" />
                                </td>
                        ...
                        : data &&
                          data.map((item: ICourse) => (
                             ...
                             >
                                ...
                                <td className="py-4 font-semibold text-lg truncate">
                                   {item.title}
                                </td>
                              ...
                              ${
                                ...
                                <td className="py-4 text-center">
                                   <div className="items-center justify-center flex flex-row gap-2">
                                      <MdOutlineDelete
                                         className="text-danger rounded-sm hover:bg-hover-2 text-4xl p-1"
                                         onClick={() => {
                                            onOpenDelete();
                                            setNameCourseDelete(item.title);
                                         }}
                                      />
            ...
            <div className="mt-32 flex flex-col justify-center items-center gap-2 w-full text-foreground">
               ...
               <Button
                  variant="ghost"
                  className="font-semibold hover:bg-primary"
