            ...
            <div className="flex flex-col items-center justify-center p-20 gap-2 rounded-lg  w-full ">
               <div className="">
                  <Image
                     ...
                     alt="avatar"
                     className="bg-primary rounded-sm shadow-md"
                     width={100}
                     height={100}
                     loading="lazy"
                  />
               ...
               <div>
                  <p className="text-sm bg-slate-100 text-gray-500 p-1 px-3 rounded-md mb-4">
                     {email}
                  </p>
               </div>
               ...
               <div className="w-full flex flex-col gap-3 justify-start items-start">
                  ...
                  <div className="flex flex-col gap-5 w-full mt-5">
                     ...
                     <div className="flex flex-row gap-3 w-full justify-start items-center">
                        <RadioGroup
                           classNames={{
                              ...
                              wrapper: ['flex flex-row gap-4 w-full'],
                              base: ['w-full'],
                           }}
                           label="Gender:"
                     ...
                     <div className="flex flex-row gap-3 w-full justify-start md:text-right">
                        ...
                        <textarea
                           placeholder={bio}
                           className="w-full h-auto border p-4"
                           value={bio}
                     ...
                     <div className="w-full flex justify-center items-center">
                        <div className="flex flex-row justify-center items-center gap-3 text-right w-full">
                           <Button className="bg-primary text-white px-16">Save</Button>
                        </div>
                     </div>
                  </div>
               </div>
