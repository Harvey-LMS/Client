...
const Nav = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="flex flex-row justify-center items-start w-full sticky">
            <div className={`flex flex-row justify-center items-start h-screen z-50 fixed md:sticky md:top-0 w-fix  md:block ${isMenuOpen ? "w-full " : "hidden"}`}>
                <div
                ...
                >
                    ...
                    <div className="flex flex-col w-full h-full border-r border-r-gray-300 bg-gray-200">
                        <div className="flex flex-row items-center justify-center mt-4">
                            <Link href={"/asd"} className="flex flex-row justify-center items-center gap-3">
                                <Image
                                    alt="brand"
                                    loading="lazy"
                                    src={Brand}
                        ...
                        <div className="overflow-y-auto overflow-x-hidden flex-grow">
                            <ul className="flex flex-col py-4 space-y-1">
                                ...
                                <div className="mx-3">
                                    <li className="">
                                        <Link href={"/asd"} className="px-6 rounded-md hover:bg-primary hover:text-primary-foreground flex flex-row justify-start items-center">
                                    ...
                                    <li className="">
                                        <Link href={""} className="px-6 rounded-md hover:bg-primary hover:text-primary-foreground flex flex-row justify-start items-center">
                                            <div className="flex flex-row gap-5 items-center justify-center h-12">
                                    ...
                                    <li className="">
                                        <Link href={""} className="px-12 rounded-md hover:bg-primary hover:text-primary-foreground flex flex-row justify-start items-center">
                                            <div className="flex flex-row gap-5 items-center justify-center h-12">
                                                <HiOutlineVideoCamera
                                                    className="text-3xl"
                                                />
