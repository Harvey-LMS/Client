                ...
                {editMode ? (
                    <div className="w-full">
                        ...
                        <div className="flex w-full items-center justify-center">
                            <FileUploader handleChange={handleFileChange} name="file" types={fileTypes} className="w-full" >
                                <div className="flex w-full items-center justify-center">
                                    <div
                                        className="flex w-full cursor-pointer flex-col items-center justify-center rounded-lg border-large border-dashed border-gray-300 bg-gray-50 hover:border-gray-400 dark:border-gray-800 dark:bg-stone-950 dark:hover:border-gray-700 dark:hover:bg-stone-900"
                                    >
                                        <div className="flex flex-col items-center justify-center p-5 w-full bg-[#F1F1F1]">

                                            {valueInput ? (
                                                <Image className="border rounded-lg object-cover w-[680px] h-[400px] " width={500} height={50} alt="thumbnail" src={valueInput as string}></Image>
                                            ) : (
                    ...
                    valueInput ? (<div className="items-center flex justify-center w-full">

                            <Image className="border rounded-lg object-cover w-[680px] h-full max-h-[400px] " width={500} height={50} alt="thumbnail" src={valueInput as string}></Image>
